...
Project ini cocok sebagai bukti portofolio IoT + mobile:

1. Link repo GitHub ini
2. Video demo 3–5 menit (YouTube unlisted)
3. Screenshot UI + foto hardware
4. (Opsional) APK di GitHub Releases
